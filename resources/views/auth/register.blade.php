...
<head>
    <meta charset="UTF-8">
    <title>Logueate a la Tanda</title>
    ...
    <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
        ...
        <div class="panel panel-default" >
            <div class="panel-heading">
                <div class="panel-title text-center">Tanda</div>
            </div>

            <div class="panel-body" >

                <form name="form" id="form" action="/auth/register" class="form-horizontal" enctype="multipart/form-data" method="POST">
                    {!! csrf_field() !!}
                    ...
                    <div class="input-group">
                        ...
                        <input id="email" type="email" class="form-control" name="email" value="{{ old('mail') }}" placeholder="Correo electronico">
                    </div>
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-key"></i></span>
                        <input id="password-confirmation" type="password" class="form-control" name="password_confirmation" placeholder="Confirmar Contraseña">
                    </div>

                    <div class="form-group">
                        <!-- Button -->
                        <div class="col-sm-12 controls">
                            <button type="submit" href="#" class="btn btn-primary pull-right"><i class="fa fa-pencil-square-o"></i> Registrarme</button>
                        </div>
                    </div>
                    @if (count($errors) > 0)
